				...
				<div className="sidebar-content">
					...
					<div className="sidebar-stats">
						...
						<p className="whitelist-counter">
							<span
								className="whitelist-badge">★</span> Whitelisted: {state.whitelistedResults.length}
						</p>
					</div>
								...
								<div className="flex grow align-center">
									<div
										...
										onClick={(e: React.MouseEvent<HTMLDivElement>) => {
											// Prevent selecting result when trying to add to
											// whitelist.
											e.preventDefault();
											e.stopPropagation();
									...
									>
										...
										<div className="avatar-preview">
											<img
												src={user.profile_pic_url.replace("s150x150/", "s320x320/")}
												alt={user.username}/>
										</div>
